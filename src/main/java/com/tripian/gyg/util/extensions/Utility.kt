...
fun String.toLargeUrl(): String {
    return replace("https://poi-pics.s3-eu-west-1.amazonaws.com".toRegex(), "https://d2v9cz8rnpdl6f.cloudfront.net/800x600")
}

fun String.toSmallUrl(): String {
    return replace("https://poi-pics.s3-eu-west-1.amazonaws.com".toRegex(), "https://d2v9cz8rnpdl6f.cloudfront.net/128x128")
}
...
fun Activity.redirectToBrowser(url: String) {
...
fun AppCompatActivity.openCustomTabExt(url: String) {
    ...
    if (activityInfo != null) {
        try {
            ...
            val colorInt: Int = ContextCompat.getColor(this, R.color.tripianRed)
