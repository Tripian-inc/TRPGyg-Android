...
interface ExperiencesService {
    ...
    suspend fun deleteBooking(
        @Path("bookingHash") bookingHash: String, @Query("cnt_language") language: String, @Query("currency") currency: String
    ): BaseModel
    ...
    @POST("carts")
    suspend fun pay(@Body request: PaymentRequest): PayResponse
}