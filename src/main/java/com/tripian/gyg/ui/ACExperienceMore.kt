...
class ACExperienceMore : BaseActivity<AcExperienceMoreBinding>() {
    ...
    override fun setListeners() {
        vi.tvTitle.text = Tripian.getLanguage()?.invoke("trips.myTrips.localExperiences.tourDetails.experience.importantInformation")
        vi.tvDescriptionTitle.text = Tripian.getLanguage()?.invoke("trips.myTrips.localExperiences.tourDetails.experience.fullDescription")
