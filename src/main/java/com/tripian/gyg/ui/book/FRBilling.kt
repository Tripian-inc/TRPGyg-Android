...
//        (requireActivity() as ACBook).setPageTitle(R.string.page_title_billing)
    ...
    override fun setListeners() {
        vi.etFirstName.setText(Tripian.firstName)
        vi.etLastName.setText(Tripian.lastName)
        vi.etMail.setText(Tripian.email)
        ...
        vi.btnNext.setOnClickListener {
            ...
            send(
                ...
                vi.etCity.text.toString(), vi.etState.text.toString(), vi.etAddressLine1.text.toString(), vi.etAddressLine2.text.toString(), vi.etPostalCode.text.toString()
            )
        }
    ...
    private fun send(
        ...
        travelFirstName: String, travelLastName: String, travelEmail: String, travelPhone: String, city: String,
        state: String, address_line_1: String, address_line_2: String, postal_code: String
    ) {
        ...
        if (validationOk) {
            viewModel.send(firstName, lastName, email, phone, country, useBillingInfo, travelFirstName, travelLastName, travelEmail, travelPhone, city, state, address_line_1, address_line_2, postal_code)
        }
    }
}